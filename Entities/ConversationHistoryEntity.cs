    ...
    public class ConversationHistoryEntity : TaskEntity<ChatHistory>
    {
        ...
        public async Task<string> GetSummary(){
            ...
            """
                ...
                - Be extremely short, concise, and to the point
                - Be clear and easy to understand

                This summary must never:
                - Consider either system messages or developer messages
                ...
                Rules:
                 - This summary will be used as a string in a json object.
                 - if you used any special characters, please escape them so that they are not interpreted as json.
            """;

            var temp = GetConversationHistory();
            temp.AddSystemMessage(instructions);
            var ccs = _semanticKernelService.GetChatCompletionService();
            var summary = await ccs.GetChatMessageContentAsync(temp, _semanticKernelService.GetOpenAIPromptExecutionSettings(), _semanticKernelService.Kernel);
